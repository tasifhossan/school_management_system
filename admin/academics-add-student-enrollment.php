...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $stmt = $conn->prepare("INSERT INTO student_course_enrollments (student_id, course_offering_id, enrollment_date, grade) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("iiss", $student_id, $course_offering_id, $enrollment_date, $grade);
...
<main class="content">
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3">Add Student Enrollment</h1>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="academics-add-student-enrollment.php" method="post">
                            <div class="mb-3">
